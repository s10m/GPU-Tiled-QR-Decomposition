...
qr : obj/qrdecomp.o obj/gridscheduler.o obj/gpucalc.o makefile
	nvcc $(CUDA_MYFLAGS) obj/gpucalc.o obj/qrdecomp.o obj/gridscheduler.o -lm -lpthread -o qr
qr-nocuda : obj/qrdecomp.o obj/gridscheduler.o makefile
	gcc -O3 obj/qrdecomp.o obj/gridscheduler.o -lm -lpthread -o qr-nocuda
obj/gpucalc.o : include/gpucalc.h src/gpucalc.cu makefile
	nvcc $(CUDA_MYFLAGS) -c src/gpucalc.cu -o obj/gpucalc.o
